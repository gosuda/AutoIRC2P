...
const en = {
  ...
  account: 'Account', password: 'Password', nick: 'Nickname', close: 'Close',
  loginTitle: 'Welcome back.', registerTitle: 'Make yourself at home.',
  loginDescription: 'Sign in with your nickname and password to send messages.',
  registerDescription: 'Choose a nickname and password to join the conversation. Reading needs no account.',
  nickNote: 'Your nickname is your sign-in name. Use 3–24 characters: start with an English letter, then use English letters, numbers, _ or -.',
  ...
  readerConnecting: 'Incoming feed is connecting', readerUnavailable: 'Incoming feed unavailable',
...
const ko: typeof en = {
  ...
  account: '계정', password: '비밀번호', nick: '닉네임', close: '닫기',
  loginTitle: '다시 만나 반가워요.', registerTitle: '나만의 이름으로 참여하세요.',
  loginDescription: '닉네임과 비밀번호로 로그인하여 메시지를 보내세요.',
  registerDescription: '닉네임과 비밀번호를 정하고 대화에 참여하세요. 읽기는 계정 없이 가능합니다.',
  nickNote: '닉네임으로 로그인합니다. 영문자로 시작하는 3~24자의 영문자, 숫자, _ 또는 -를 사용하세요.',
  ...
  readerConnecting: '수신 연결 준비 중', readerUnavailable: '수신 연결을 사용할 수 없음',
